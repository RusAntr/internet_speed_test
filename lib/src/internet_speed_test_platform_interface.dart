...
import 'package:internet_speed_test/src/internet_speed_test_method_channel.dart';
...
abstract class FlutterInternetSpeedTestPlatform extends PlatformInterface {
  ...
  Map<
      int,
      Tuple4<ErrorCallback, ProgressCallback, DoneCallback,
          CancelCallback>> callbacksById = <int,
  ...
  /// platform-specific class that extends [FlutterInternetSpeedTestPlatform]
