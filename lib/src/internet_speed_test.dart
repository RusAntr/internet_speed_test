...
import 'package:internet_speed_test/src/test_result.dart';
...
class FlutterInternetSpeedTest {
  ...
  Future<void> startTesting({
    ...
    if ((downloadTestServer == null || uploadTestServer == null) &&
      ...
      final url = serverSelectionResponse?.targets?.first.url;
      if (url != null) {
  ...
  Future<bool> cancelTest() async {
    _isCancelled = true;
    return FlutterInternetSpeedTestPlatform.instance.cancelTest();
  }
