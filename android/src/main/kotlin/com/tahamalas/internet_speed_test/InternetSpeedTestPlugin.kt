...
/** InternetSpeedTestPlugin */
class InternetSpeedTestPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        ...
        methodChannel =
            MethodChannel(flutterPluginBinding.binaryMessenger, "com.tahamalas.plugin.fist/method")
        methodChannel.setMethodCallHandler(this)
    }

    override fun onMethodCall(call: MethodCall, result: Result) {
        print("InternetSpeedTestPlugin: onMethodCall: ${call.method}")
        this.result = result
        when (call.method) {
